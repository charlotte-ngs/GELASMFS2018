...
## Example 
A simple example of model (\ref{eq:LinMixedModel}) is that of first lactation yields of dairy cows with sire additive genetic merit^[also known as breeding values] being treated as random effects ($u$) and herds being treated as fixed effects ($\beta$).  
