...
## Schon vergebene Themen

### ZUCHT AUF FRÜHREIFE BEI FLEISCHRINDERN {#project_header .emphasized}
Student: Silvan Wyss

Die Frühreife beim Fleischrind ist ein Merkmals von grosser wirtschaftlicher Bedeutung. Die züchterische Bearbeitung dieses Merkmals ist alles andere als trivial. In dieser Arbeit sollen mögliche Ansätze für eine Zucht auf Frühreife beschrieben und verglichen werden. Für eine detailierte Beschreibung der Aufgabestellung, bitte hier [weiterlesen](20180321_FruehreifeFleischrind.html) ... 
