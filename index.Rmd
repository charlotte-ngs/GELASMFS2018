...
vec_topics_schedule[which(Datum == format(as.Date("2018/04/30"), "%d.%m"))] <- "Braunvieh Schweiz und Qualitas"
vec_topics_schedule[which(Datum == format(as.Date("2018/05/07"), "%d.%m"))] <- "ZWS Rind III"
